        ...
        <div class="table">
          <div class="table-toolbar">
            <div class="pt-wrapper">
              <div class="pt-left">
                <div class="text-block-3">Cryptocurrencies Sorted by Volatility Ascending</div>
              </div>
              <div class="pt-right">
              ...
              <div class="table-row" v-for="value in coins" :key="value">
                ...
                <div class="cell l">
                  <div class="change-wrap">
                    <div :class="percentValueStyler(value.price_change_percentage_1h_in_currency)">{{ parseFloat( value.price_change_percentage_1h_in_currency?.toLocaleString() ).toFixed(2) }}%</div>
                  </div>
                </div>
                <div class="cell l">
                  <div class="change-wrap">
...
export default {
    ...
    methods: {
      ...
      percentValueStyler(value) { return {
          'positivePct': value > 0 && value <= 25, 'positivePctLarge': value > 25,
          'negativePct': value < 0 && value >= -25, 'negativePctLarge': value < 25,
          'neutralPct': value = 0,
        };
      },
